...
materials :: materials(double density_chosen2,double yield_strength_chosen2)
{
...
{
    cout << "material name \t yield strength (MPa)  density (g/cm^3) \n" ; //alway: to know what is the data given in table and unit
    for(int i=0; i<=8; i++)
    {
vector<string> name = {"Cast iron", "Copper nickel", "Brass", "Aluminum", "Steel", "Acrylic", "Copper", "Stainless steel", "Tungsten" };
